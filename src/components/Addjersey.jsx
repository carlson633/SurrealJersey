...
const Addproduct = () => {
  ...
  const uploadProduct = async (e) =>{
    ...
    try{
      ...
      const response = await axios.post("https://CarlsonKadendi.pythonanywhere.com/api/addproduct", data)
    ...
    <div className="row justify-content-center mt-3">
      <div className="col-md-6 card shadow p-3">
        ...
        <form onSubmit={uploadProduct}>
          ...
          placeholder="Enter the name of desired jersey"
          ...
          <textarea
          required
          placeholder="Partially describe the jersey in terms of colour, size and quality"
          ...
          <input type="number"
          required
          placeholder="Enter the price of the chosen jersey"
          value={productPrice}
          ...
          <label> Choose the photo of the chosen jersey </label> <br />
          <input
          type="file"          
